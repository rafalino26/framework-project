...
const renderMainContent = () => {
        ...
        {activeTab === "courses" ? (
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  {filteredCourses.length > 0 ? (
                    ...
                    // Ini adalah Filtered Empty State Anda
                    <tr>
          ...
          <>
            <div id="printable-content">
              ...
              {/* Pesan jika belum ada matkul dipilih */}
              {selectedCourseDetails.length === 0 ? (
                ...
                <div className="space-y-6 mt-4">
                  {days.map((day) => {
                    ...
                    if (dayCourses.length === 0) return null; // Jangan render apapun jika tidak ada jadwal di hari itu
                    return (
                      <div key={day}>
  ...
  return (
    <div className="text-black space-y-6 p-4 md:p-6">
      ...
      {/* Card Container - memanggil fungsi render kondisional */}
